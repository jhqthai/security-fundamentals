...
int main (int argc, const char *argv[])
{
	/* This variable is used to store the ciphertext provided to you. Make sure to use the proper format, eg. the hex 'd23a' would be written as {0xd2,0x3a} in C */
		// 0x20, 0x75, 0x38, 0x6b, 0x75, 0xee, 0xd8, 0xb4, 0xf2, 0xb4, 0xa9, 0xc9, 0xb7, 0x69, 0x67, 0xd0, 0x72, 0xfe, 0x22, 0xda, 0xca, 0x7b, 0x8f, 0x5a, 0x56, 0xd1, 0x6c, 0xe6, 0xee, 0x48, 0x3b, 0x59
	...
	if (/* Use this statement to check is the words.txt file can be opened in 'rt' permission */)
	{
